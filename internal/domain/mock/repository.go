...
func (m *MockRepository) GetProxies(countryCode string, limit int) ([]domain.Proxy, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetProxy(address domain.NetIP) (domain.Proxy, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) TopProxyTypes(limit int) ([]domain.ProxyType, error) {
	m.ctrl.T.Helper()
